	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span class="glyphicon glyphicon-signal"></span> Short Block App<span></span></a>
				<ul class="user-menu">
				...
				<div class="panel panel-teal panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"></div>
							<a href="transaksi1.php"><div class="text-muted"><strong>Scan IN Short Blocks</strong></div></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-red panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"></div>
							<a href="transaksi2.php"><div class="text-muted"><strong>Scan OUT Short Blocks</strong></div></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						<a href="laporan1.php">
						<div class="col-sm-3 col-lg-5 widget-left">
							<em class="glyphicon glyphicon glyphicon-th glyphicon-l"></em>
						</div>
						</a>
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"></div>
							<a href="laporan1.php"><div class="text-muted"><strong>Lihat Stock</strong></div></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"></div>
							<a href="history1.php"><div class="text-muted"><strong>Mutasi</strong></div></a>
						</div>
					</div>
				</div>
			</div>
