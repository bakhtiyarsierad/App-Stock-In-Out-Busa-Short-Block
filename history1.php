					...
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="tgl" data-sort-order="desc">
						    ...
						    <tr>
								...
								<th data-field="iduser" data-sortable="true">User ID</th>
							</tr>
							</thead>
							<tbody>
							<?php
//---------------------------------------------- INSERT TABLE ------------------------------------------------------
							...
							if(substr($_SESSION['level'],0,6)=='gudang')
							{
								...
								$sqltrx="select t.id_transaksi,t.id_user,t.tgl_transaksi,t.jenis_transaksi,t.id_barang,t.id_gudang,t.no_do,t.jumlah,t.keterangan,b.nama_barang,b.satuan,g.nama_gudang from transaksi t, barang b, gudang g where (t.id_barang=b.id_barang) and (t.id_gudang=g.id_gudang) and (t.id_gudang=$idgudang) order by t.id_transaksi desc limit 0,100";
							}
							else
							{
								$sqltrx="select t.id_transaksi,t.id_user,t.tgl_transaksi,t.jenis_transaksi,t.id_barang,t.id_gudang,t.no_do,t.jumlah,t.keterangan,b.nama_barang,b.satuan,g.nama_gudang from transaksi t, barang b, gudang g where (t.id_barang=b.id_barang) and (t.id_gudang=g.id_gudang) order by t.id_transaksi desc limit 0,100";				
							}
							...
							<tr>
								...
								<td data-field="iduser" data-sortable="true">'.$datatrx['id_user'].'</td>
						    </tr>';
							}
//---------------------------------------------- INSERT TABLE ------------------------------------------------------							
							?>
