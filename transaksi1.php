	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span class="glyphicon glyphicon-signal"></span> Short Block App Stock<span></span></a>
				<ul class="user-menu">
...
//-------------------------LOOKUP DATA BARANG-------------------------------------------------------------
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="do" placeholder="Isi Dengan No Batch">
								</div>
								
								<div class="form-group">
									<label>Qty </label>
									<input type="text" class="form-control" name="jumlah" placeholder="Masukkan angka">
									<input type="hidden" class="form-control" name="user" value='<?php echo $pengguna; ?>' >
								</div>
